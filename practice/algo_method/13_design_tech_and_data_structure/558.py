...
class UnionFind:
    ...
    def __init__(self, N: int):
        ...
        self._min_node: List[int] = [i for i in range(N)]
    ...
    def unite(self, x: int, y: int) -> bool:
        ...
        # Update min_node
        self._min_node[rx] = min(self._min_node[rx], self._min_node[ry])
    ...
    def get_min_node(self, x: int) -> int:
        return self._min_node[self.get_root(x)]
